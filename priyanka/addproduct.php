            ...
            <div class="container-fluid">
               <div class="row d_flex">
                  <div class=" col-md-2 col-sm-3">
                     <div class="logo">
                        <<a href="index.html">Farmer's<span>Buddy</span>
                     </div>
                  </div>
         ...
         <div class="container">
            <div class="row">
               ...
               <div class="col-md-8 offset-md-2">
                  <form action="storeproduct.php" method="POST"  enctype="multipart/form-data"  class="main_form">
                     <div class="row">
						...
						<select class="form_control" type="text" name="cat" required>
						   ...
						   <option>CROP</option>
							...
							<div class="col-md-12 ">
                           <span class="form_control" name="user" required ><?php echo $_SESSION['UNAME'];?></span>
                        </div>
