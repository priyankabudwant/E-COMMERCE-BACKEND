      ...
      <div class="full_bg">
                  ...
                  <div class="col-md-8 col-sm-9">
                     <div class="navbar-area">
                        <nav class="site-navbar">
                         <ul>
                              <li><a  class="active" href="farmer_dashboard.php">Dashboard</a></li>
                              <li><a  href="farmer_buy_product.php">Products</a></li>
                              <li><a href="shownews.php">News</a></li>
                                <li><a href="cropinfo.php">Crop Information</a></li>
                                <li><a href="about_admin_farmer.html">About Us</a></li>
         ...
         <!--carousel code -->
             <div id="banner1" class="carousel slide carousel-fade" data-ride="carousel" data-interval="6000">
                    ...
                    <h2 name="uname">"HELLO <?php echo $_SESSION['UNAME'];?> "</h2>
					 <h2>WELCOME  TO  FARMERS  DASHBOARD</h2>
                  </div>
      ...
      <div class="choose">
            ...
            <div class="row">
               <div class="col-md-3">
                  <div class="point text_align_center">
                     <a href="farmer_buy_product.php"><h3>🛍️</h3></a>
                     <a href="farmer_buy_product.php"><span>BUY<br>PRODUCT</span></a>
                  </div>
               </div>
               
               <div class="col-md-3">
                  <div class="point text_align_center">
                      <a href="shownews.php"><h3>📰</h3></a>
                     <a href="shownews.php"><span>NEWS</span></a>
                  </div>
               </div>
			   
               <div class="col-md-3">
                  <div class="point text_align_center">
                     <a href="cropinfo.php"><h3>🌾</h3></a>
                      <a href="cropinfo.php"><span>CROP<BR>INFORMATION <br></span></a>
                  </div>
               </div>
			   
			   <div class="col-md-3">
                  <div class="point text_align_center">
                     <a href="farmer_product.php"> <h3>📦</h3></a>
                      <a href="farmer_product.php"><span>ADD PRODUCT<br></span></a>
                  </div>
               </div>
         ...
         <div class="container">
            ...
            <div class="row">
			     ...
			     <div class="col-md-3">
                  <div class="point text_align_center">
                     <a href="farmer_sold.php"><h3>💲</h3></a>
                     <a href="farmer_sold.php"><span>SOLD PRODUCT<br> DETAILS</span></a>
                  </div>
               </div>
			   
               <div class="col-md-3">
                  <div class="point text_align_center">
                     <a href="contact.html"><h3>📝</h3></a>
                     <a href="contact.html"><span>FEEDBACK <br></span><a href="contact.html">
                  </div>
               </div>
			   
			   <div class="col-md-3">
                  <div class="point text_align_center">
                     <a href="view_farme_order_details.php"><h3>🚚</h3></a>
                     <a href="view_farme_order_details.php"><span>TRACK<br>ORDER</span></a>
                  </div>
               </div>
