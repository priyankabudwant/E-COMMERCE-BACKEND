               ...
               <div class="col-md-4">
                  <div class="services_box_main">
                     <div  class="services_box text_align_left">
                        ...
                        <div class="veget">
                           <h3 style="font-size:25px;">UName:'.$row["uname"].'</h3>
						   <h4 style="font-size:22px;">Name:'.$row["fname"].'</h4>
                           <h4 style="font-size:22px;">Mobile:'.$row["uphone"].'</h4>
						   <h4 style="font-size:22px;">Email:'.$row["uemail"].'</h4>
						   <h4 style="font-size:22px;">Password:'.$row["upassword"].'</h4>
						   <h4 style="font-size:22px;">Utype:'.$row["utype"].'</h4>
						   <h4 style="font-size:22px;">UState:'.$row["ustate"].'</h4>
						   <h4 style="font-size:22px;">Ucity:'.$row["ucity"].'</h4>
						   <h4 style="font-size:22px;">Uaddress:'.$row["uaddress"].'</h4>
                        </div>
                     </div>
