                     ...
                     <div class="navbar-area">
                        <nav class="site-navbar">
                            <ul>
							  ...
							  <li><a class="active" href="buyer_feedback.php">feedback</a></li>
         ...
         <div class="container">
            <div class="row">
               ...
               <div class="col-md-8 offset-md-2">
                  <form action="buyer_feed.php" method="post"  class="main_form">
                     <div class="row">
					  <div class="col-md-12 ">
						   
                           <input class="form_control" placeholder="Your Name" type="text" name="fname" required > 
                        </div>
                        <div class="col-md-12">
                           <input class="textarea" placeholder="Your feedback" type="text" name="feedback" required> 
                        </div>
