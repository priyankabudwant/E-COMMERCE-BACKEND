                     ...
                     <div class="navbar-area">
                        <nav class="site-navbar">
                         <ul>
                              ...
                              <li><a class="active" href="addproductadmin.php">Product</a></li>
         ...
         <div class="container">
            <div class="row">
               ...
               <div class="col-md-8 offset-md-2">
                  <form action="storeproductadmin.php" method="POST"  enctype="multipart/form-data"  class="main_form">
                     <div class="row">
					...
					<div class="col-md-12">
                           ...
                           <div class="col-md-12">
							...
							<span class="form_control" name="user" style="visibility:hidden" required ><?php echo $_SESSION['auname'];?></span>
							  </div>
					<br></br>
