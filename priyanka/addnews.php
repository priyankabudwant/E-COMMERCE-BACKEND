                  ...
                  <form action="view_news.php" enctype="multipart/form-data" method="post"  class="main_form">
                     <div class="row">
                        ...
                        <div class="col-md-12 ">
                           ...
                           <input class="form_control" placeholder="Heading Of News" type="text" name="heading" required > 
                        </div>
						...
						<div class="col-md-12">
						<select class="form_control" type="text" name="utype" required>
							<option>ADMIN</option>
						</select>
						</div>
					...
					<div class="col-md-12">
                           <input class="textarea" placeholder="Enter The News Description" type="text" name="Ndesc" required> 
                        </div>
                           ...
                           <div class="col-md-12">
						         <p>
								Choose A Image
								<input  type="file" name="image" placeholder="Insert Image"></p>
