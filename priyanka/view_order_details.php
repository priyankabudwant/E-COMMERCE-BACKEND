                     ...
                     <div class="navbar-area">
                        <nav class="site-navbar">
                          <ul>
                              ...
                              <li><a class="active" href="view_order_details.php">Track Order</a></li>
							  <li><a href="buyer_feedback.php">feedback</a></li>
               ...
               <div class="row">
                  <div class="col-sm-12">
                     <div class="titlepage text_align_left">
                         <span></span>
                         <h2 STYLE="margin-left:80px;">DETAILS OF ORDER </h2>
                     </div>
                  </div>
               </div>
            </div>
                          ...
                          <?php
																  ...
																  
														{
																 $a=$_SESSION['UNAME'];
																	...
																	$sql="Select * from  orders where uname='$a' ORDER BY oid DESC;" ;
                           ...
                           <div class="col-md-5" style="margin:30px;">
                              <div class="custom">
                                 <div class="d_flex">
                                    <i><img src="images/'.$row["pimage"].'"width="150" height="120" alt="#"/></i>
                                    <div class="clint">
									 <h4 style="font-family:rockwell;size:22px;color:black;" >Order Id:'.$row["oid"].'</h4>
									 <br>
                                      <h4 style="font-family:rockwell;size:22px;color:black;" >Buyer Name:'.$row["uname"].'</h4>
									  <br>
									  <h4 style="font-family:rockwell;size:22px;color:black;"> Product Name : '.$row["opname"].'</h4>
									  <br>
									  <span style="font-family:rockwell;color:black;font-size:22px;">Delivery Status :'.$row["orderstatus"].'</span>
									  <br>
                                      <span style="font-family:rockwell;color:red;font-size:22px;">Product Price :'.$row["oprice"].'.Rs</span>
									  <br>
									  
									  
																				  
													<br>
												<a href="buyer_dashboard.php"><button class="read_more" name="send_btn" >GO BACK</button></a>
												</form>
										<br><br>
