                           ...
                           <div class="col-md-6">
                              <div class="custom">
                                 <div class="d_flex">
                                    ...
                                    <div class="clint">
                                    <span style="color:blue;" >  User Name :'.$row["fname"].'</span>
									  <br>
                                      <span style="margin-left:30px;color:red;" >Phone :'.$row["uphone"].'</span>
									  <span style="margin-left:30px;color:red;">Email :'.$row["uemail"].'</span>
                                    </div>
                                 </div>
                                  <p  style="margin-left:30px;">"'.$row["message"].'"</p>
								  <a  class="read_more" href="allactions.php?fid='.$row["fid"].'" style="margin-left:130px;"> Delete</a>
