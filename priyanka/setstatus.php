                     ...
                     <div class="navbar-area">
                        <nav class="site-navbar">
                             <ul>
                              ...
                              <li><a class="active" href="view_all_orders.php">Update Status</a></li>
               ...
               <div class="row">
                  <div class="col-sm-12">
                     <div class="titlepage text_align_left">
                         <span></span>
                         <h2 STYLE="margin-left:80px;">DETAILS OF ORDER DETAILS BY BUYERS</h2>
                     </div>
                  </div>
               </div>
            </div>
                     ...
                     <div class="carousel-caption relative">
                        <div class="row d_flex">
                          <?php
																   ...
																   if(isset($_GET['oid']))
														{
																   $a=test_input($_GET['oid']);

																	$sql="Select * from  orders where oid='$a'" ;
									 ...
									 <br>
									  ...
									  <br>
												...
												<form action="dstatus.php" method="post">								  
													<select type="text"  name="orderstatus">
													...
													<BR><BR>
												<button class="read_more" name="send_btn" >SUBMIT</button>
												</form>
										<br><br>
