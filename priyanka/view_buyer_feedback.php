               ...
               <div class="row">
                  <div class="col-sm-12">
                     <div class="titlepage text_align_left">
                         <span></span>
                         <h2>VIEW ALL BUYER'S  FEEDBACK</h2>
                     </div>
                  </div>
               </div>
            </div>
                           ...
                           <div class="col-md-6">
                              <div class="custom">
                                 <div class="d_flex">
                                  ...
                                  <p  style="margin-left:30px;">"'.$row["feedback"].'"</p>
								  <a  class="read_more" href="allactions.php?bfid='.$row["bfid"].'" style="margin-left:130px;"> Delete</a>
