               ...
               <div class="col-md-4" >
                  <div class="services_box_main" >
                     <div  class="services_box text_align_left">
                          <figure><img src="images/'.$row["pimage"].'" alt="#"/></figure>
                        <div class="veget">
                           <h3>'.$row["pname"].'</h3>
						   <span style="color:red;font-size:30px;">	₹'.$row["price"].'.RS</span>
                           <p>'.$row["pdesc"].'</p>
                        </div>
                     </div>
                     <a class="read_more" href="allactions.php?pid='.$row["pid"].'">REMOVE PRODUCT</a>
                  </div>
               </div>
