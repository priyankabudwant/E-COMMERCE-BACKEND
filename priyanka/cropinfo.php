...
<h2>HELLO <?php echo $_SESSION['UNAME'];?> </h2>
 ...
 <h2 style="text-align: center;" >CROPS</h2>
</div>
</div>  
<div class="row">	
<?php
			...
			echo '<div class="col-md-4" >
                  <div class="services_box_main" >
                     <div  class="services_box text_align_left">
                          <figure><img src="images/'.$row["cimage"].'" alt="#" name="img" /></figure>
                        <div class="veget">
                        
						   <h3 >'.$row["heading"].'</h3>
						    <span style="visibility:hidden;">'.$row["cid"].'</span>
						    <a href="view_full_crop.php?cid='.$row["cid"].'" style="color:while;"><button class="read_more" ame="btn">SEE MORE</button></a>
                        </div>
                     </div>
				    </div>
               </div>';
