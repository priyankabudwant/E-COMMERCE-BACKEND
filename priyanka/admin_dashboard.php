      ...
      <div class="full_bg">
         ...
         <!--carousel code -->
             <div id="banner1" class="carousel slide carousel-fade" data-ride="carousel" data-interval="6000">
                     ...
                     <h2>DASHBOARD</h2>
					  <h2>"HELLO <?php echo $_SESSION['aname'];?> "</h2>
                  </div>
      ...
      <div class="choose">
            ...
            <div class="row">
               <div class="col-md-3">
                  <div class="point text_align_center">
                     <a href="view_users.php"><h3>👩🏻‍💻️</h3></a>
                     <a href="view_users.php"><span>VIEW <br>USERS</span></a>
                  </div>
               </div>
               
               <div class="col-md-3">
                  <div class="point text_align_center">
                     <a href="addnews.php"><h3>📰</h3></a>
                     <a href="addnews.php"><span>ADD<BR>NEWS</span></a>
                  </div>
               </div>
			   
			     <div class="col-md-3">
                  <div class="point text_align_center">
                     <a href="addproductadmin.php"><h3>📦</h3></a>
                      <a href="addproduct.php"><span>ADD PRODUCT<br></span></a>
                  </div>
               </div>
			   
			     <div class="col-md-3">
                  <div class="point text_align_center">
                     <a href="view_all_orders.php"><h3>🚚</h3></a>
                      <a href="view_all_orders.php"><span>UPDATE<br>ORDER DETAILS</span></a>
                  </div>
               </div>
         ...
         <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                  <div class="point text_align_center">
                     <a href="addcrops.php"><h3>🌾</h3></a>
                     <a href="addcrops.php"><span>CROP<BR>INFORMATION <br></span></a>
                  </div>
               </div>
             
			 <div class="col-md-3">
                  <div class="point text_align_center">
                     <a href="displayproduct.php"><h3>📦</h3></a>
                     <a href="displayproduct.php"><span>VIEW <br>PRODUCTS</span></a>
                  </div>
               </div>
			   
			     <div class="col-md-3">
                  <div class="point text_align_center">
                     <a href="admin_sold.php"><h3>💲</h3></a>
                     <a href="admin_sold.php"><span>SOLD PRODUCT<br> DETAILS</span></a>
                  </div>
               </div>
			   
               <div class="col-md-3">
                  <div class="point text_align_center">
                     <a href="showfeedback.php"><h3>📝</h3></a>
                      <a href="showfeedback.php"><span>VIEW <br>FEEDBACK</span></a>
                  </div>
               </div>
       ...
       <div class="choose">
         <div class="container">
            ...
            <div class="row">
			    ...
			    <div class="col-md-3">
                  <div class="point text_align_center">
                     <a href="admin_view_news.php"><h3>📰</h3></a>
                     <a href="admin_view_news.php"><span>REMOVE<BR>NEWS</span></a>
                  </div>
               </div>
			    ...
			    <div class="col-md-3">
                  <div class="point text_align_center">
                       <a href="view_buyer_feedback.php"><h3>💬</h3></a>
                       <a href="view_buyer_feedback.php"><span>VIEW BUYERS<br>FEEDBACK</span></a>
                  </div>
               </div>
