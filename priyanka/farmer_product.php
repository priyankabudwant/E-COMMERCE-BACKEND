                     ...
                     <div class="navbar-area">
                        <nav class="site-navbar">
                          <ul>
                              ...
                              <li><a class="active" href="farmer_buy_product.php">Products</a></li>
            ...
            <div class="row">
               <div class="col-md-12 ">
                  <div class="titlepage text_align_center">
                     <span>"HELLO <?php echo $_SESSION['UNAME'];?> "</span>
					 <h2>ADD PRODUCT</h2>
               ...
               <div class="col-md-8 offset-md-2">
                  <form action="storeproductfarmer.php" method="POST"  enctype="multipart/form-data"  class="main_form">
                     <div class="row">
					 
                        <div class="col-md-12 ">
                           <input class="form_control" placeholder="Product Name" type="text" name="pname" required > 
                        </div>
						
						<div class="col-md-12 ">
                           <input class="form_control" placeholder="Product Price" type="text" name="price" required > 
                        </div>
						
							<div class="col-md-12 ">
                           <input class="form_control" placeholder="Product Quantity" type="text" name="quantity" required > 
                        </div>
						
						
						<div class="col-md-12">
						<select class="form_control" type="text" name="cat" required>
						...
						<div class="col-md-12">
                          <span class="form_control" name="user" style="visibility:hidden" required ><?php echo $_SESSION['UNAME'];?></span>
                        </div>
						
					
					<div class="col-md-12">
                           <input class="textarea" placeholder="Enter The Product Description" type="text" name="pdesc" required> 
                        </div>
					...
					<br></br>
                        ...
                        <div class="col-md-12">
                           <div class="group_btn">
                           <button class="send_btn"  name="send_btn">SUBMIT</button>
                         <br></br>
                         </div>
                        </div>
