      ...
      <div class="full_bg">
                  ...
                  <div class="col-md-8 col-sm-9">
                     <div class="navbar-area">
                        ...
                        <ul>
                              ...
                              <li><a class="active" href="shownews.php">News</a></li>
         ...
         <!-- end header inner -->
							 ...
							 <br></br>
	                             ...
	                             <h1 style="text-align:center;font-size:300%;font-family:Comic sans MS;color:#6F9C14;">LATEST NEWS</h1>
							</div>
            ...
            <div class="row d_flex">
               ...
               <div class="col-lg-6 col-md-12">
                  <div class="row d_flex">
                   <div class="col-md-7">
                     <div class="about_img">
                        <figure><img src="images/'.$row["image"].'" alt="#"/>
                        </figure>
                     </div>
                   </div>
