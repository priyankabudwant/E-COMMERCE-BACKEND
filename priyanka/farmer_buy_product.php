			...
			echo '<div class="col-md-4" >
                  <div class="services_box_main" >
                     <div  class="services_box text_align_left">
                          <figure><img src="images/'.$row["pimage"].'" alt="#" name="img" /></figure>
                        <div class="veget">
                        
						   <h3>'.$row["pname"].'</h3>
						   <span style="color:red;font-size:30px;" name="pprice">	₹'.$row["price"].'.RS</span>
						    <a href="view_full_product_farmer.php?pid='.$row["pid"].'" style="color:while;"><button class="read_more" ame="btn">VIEW PRODUCT</button></a>
                        </div>
                     </div>
				    </div>
               </div>';
