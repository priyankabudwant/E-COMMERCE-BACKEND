         ...
         <div class="container">
            <div class="row">
               ...
               <div class="col-md-8 offset-md-2">
                  <form action="storecrop.php" enctype="multipart/form-data" method="post"  class="main_form">
                     <div class="row">
					 
                        <div class="col-md-12 ">
						   
                           <input class="form_control" placeholder="NAME OF THE CROP" type="text" name="heading" required > 
                        </div>
						
	
					<div class="col-md-12">
                           <input class="textarea" placeholder="INTRODUCTION" type="text" name="intro" required> 
                        </div>
						
						<div class="col-md-12">
                           <input class="textarea" placeholder="VARIETIES" type="text" name="var" required> 
                        </div>
						
						<div class="col-md-12">
                           <input class="textarea" placeholder="CONDITION" type="text" name="con" required> 
                        </div>
						
						<div class="col-md-12">
                           <input class="textarea" placeholder="HARVEST" type="text" name="har" required> 
                        </div>
						
						<div class="col-md-12">
                           <input class="textarea" placeholder="USES" type="text" name="uses" required> 
                        </div>
                           ...
                           <div class="col-md-12">
						         <p>
								Choose A Image
								<input  type="file" name="cimage" placeholder="Insert Image"></p>
					...
					<br></br>
                        ...
                        <div class="col-md-12">
                           <div class="group_btn">
                           <button class="send_btn"  name="send_btn">SAVE CROP INFO</button>
                         <br></br>
                         </div>
                        </div>
