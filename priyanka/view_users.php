            ...
            <div class="row">
               <div class="col-md-12">
                  <div class="titlepage text_align_left">
                         ...
                         <h2 style="text-align:center;">VIEW ALL USER DETAILS</h2>
                  </div>
               </div>
            </div>
            <div class="row">
               ...
               <div class="col-md-4">
                  <div class="services_box_main">
                     <div  class="services_box text_align_left">
                        ...
                        <div class="veget">
                           <h3 style="font-size:25px; color:RGB(244, 67, 54);">UName:'.$row["uname"].'</h3>
						   <h4 style="font-size:22px;  color:black;">Name:'.$row["fname"].'</h4>
                           <h4 style="font-size:22px;color:black;">Mobile:'.$row["uphone"].'</h4>
						   <h4 style="font-size:22px;color:black;">Email:'.$row["uemail"].'</h4>
						   <h4 style="font-size:22px;color:black;">Password:'.$row["upassword"].'</h4>
						   <h4 style="font-size:22px;color:black;">Utype:'.$row["utype"].'</h4>
						   <h4 style="font-size:22px;color:black;">UState:'.$row["ustate"].'</h4>
						   <h4 style="font-size:22px;color:black;">Ucity:'.$row["ucity"].'</h4>
						   <h4 style="font-size:22px;color:black;">Uaddress:'.$row["uaddress"].'</h4>
                        </div>
                     </div>
                     <a class="read_more" href="allactions.php?uid='.$row["uid"].'"> Delete</a>
                  </div>
               </div>
