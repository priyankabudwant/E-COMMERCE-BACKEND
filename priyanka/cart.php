...
<html lang="en">
   ...
   <body class="main-layout inner_page about_page">
	  ...
	  <div class="container-fluid">
							 <br></br>
							     <h2 style="text-align:center;font-size:300%;font-family:Comic sans MS;">"HELLO <?php echo $_SESSION['UNAME']; $a=$_SESSION['UNAME'];?> " </h2>
								 
	                             <h1 style="text-align:center;font-size:300%;font-family:Comic sans MS;color:#6F9C14;">Cart</h1>
							</div>
...
$pid=test_input($_GET['pid']);
         ...
         <div class="container-fluid" >
            <div class="row d_flex" >
                       ...
                       <img src="images/'.$row["pimage"].'" alt="#" style="height:250px;width:200px;margin-left: 300px;">
                          <h2 style="font-family:rockwell;font-size:25px;">'.$row["pname"].  '</h2>
					     <span style="color:red;font-size:18px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;₹'.$row["price"].  '</span>
                          
                    </div>
					 <h2 style="font-family:rockwell;margin-left:550px;color:red;font-size:40px;">Total:₹'.$row["price"].  '</h2>
					<br><br>
      <a href="storeorder.php?pid='.$row["pid"].'"  class="read_more" style="color:while;margin-left:550px;" >PLACE ORDER</a>;
