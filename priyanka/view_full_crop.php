...
$sql="Select * from crops where cid=".$cid."";
            ...
            <div class="row">
               <div class="col-md-200">
                  <div class="titlepage text_align_center" ">
                         ...
                         <h2 style="margin-left:460px;">'.$row["heading"].'</h2>
                  </div>
               </div>
            </div>
            <div class="row">
               <div class="col-md-20">
                  <div class="services_box_main">
                     <div  class="services_box text_align_left">
                          <figure><img src="images/'.$row["cimage"].'" alt="#"/ style="margin-left:370px;margin-top:30px;" width="400" height="300" ></figure>
                        <div class="veget">
                           <h3 style="color:red;">INTRODUCTION</h3>
                           <p>'.$row["intro"].'</p>
                            <br>
                           <h3 style="color:red;">TYPES</h3>
                           <p>'.$row["var"].'</p>
						     <br>
                           <h3 style="color:red;">CONDITION</h3>
                           <p>'.$row["con"].'</p>
						   <br>
                           <h3 style="color:red;">PROCESS OF HARVESTING</h3>
                           <p >'.$row["har"].'</p>
						   <br>
                           <h3 style="color:red;">USES</h3>
                           <p >'.$row["uses"].'</p>
						   
                         <br></br>
                         </div>
						 </div>
                     <a class="read_more" href="farmer_dashboard.php">GO BACK</a>
                  </div>
                        </div>
